...
export const Dimmed = (props) => <span style={{ opacity: 0.2, ...props.style }}>{props.children || props.text}</span>;
...
export const Args = (props) => {
	...
	return <Dimmed style={{ opacity: 0.5, color: props.color || 'gray' }} text={text} />;
};
...
export const FlagLine = (props) => {
	...
	if (props.hasOwnProperty('hint')) {
		hint = <Dimmed text={props.hint && props.hint.toUpperCase()} />;
	}
